$(document).ready(function () {
    ...
    // update amenityIds on checkbox change
    ...
    // make new POST request on button click
    $('button').click(function () {
      const placesUrl = 'http://0.0.0.0:5001/api/v1/places_search/';
      const requestData = { amenities: Object.keys(amenityIds) };
      ...
      .then(data => {
        ...
        placesSection.innerHTML = ''; // clear existing results
